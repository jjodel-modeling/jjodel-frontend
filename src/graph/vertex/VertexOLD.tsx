...
//         const dataClassName = this.props.data.className;
//         // effettuare distinzione tramite isVertex
//         if(dataClassName === "DClass" || dataClassName === "DEnumerator")
//             return (<Draggable>
//                 <div
...
//                                     <div className={"OverlapGrandChildren " + dataClassName} style={overlapChildStyle}>
//                                         {dataClassName === "DClass" || dataClassName === "DEnumerator" ?
//                                             <ToolButton isVertex={this.props.isVertex} data={this.props.data} /> : <></>
//                                         }
//                                         {super.render()}
//                                     </div>
//                             </Overlap>
//                             :
//                             <div className={dataClassName}>{super.render()}</div>
//                     }
//                 </div>
//             </Draggable>);
//         else
...
//                             </Overlap>
//                             :
//                             <div className={dataClassName + " w-100"}>
//                                 {dataClassName === "DAttribute" || dataClassName === "DReference" || dataClassName === "DEnumLiteral" ?
//                                     <ToolButton isVertex={this.props.isVertex} data={this.props.data} /> : <></>
//                                 }
//                                 {super.render()}
//                             </div>
