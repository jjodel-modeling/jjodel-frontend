...
export class LViewElement<Context extends LogicContext<DViewElement, LViewElement> = any, D extends DViewElement = any>
    ...
    zoom!: GraphPoint;
    __info_of__zoom: Info = {todo: true, isNode: true, type: GraphPoint, txt:<div>Zooms in or out the element using css scale.</div>}
    /*
    ...
    appliableToClasses!: string[]; // class names: DModel, DPackage, DAttribute...
    __info_of__appliableToClasses: Info = {isGlobal: true, type: {...EModelElements, ...EGraphElements, cname:"EModelElements | EGraphElements"}, label:"applicable to",
    ...
    __info_of__viewpoint: Info = {hidden: true, type: LViewPoint, txt: <div>The collection of views containing this one, useful to activate multiple views at once.</div>}
    ...
    onDragStart!: string;
    __info_of__onDragStart: Info = {todo: true, isNode: true, type: "Function():void",
    ...
    lazySizeUpdate!: boolean;
    __info_of__lazySizeUpdate: Info = {isGlobal: true, type: ShortAttribETypes.EBoolean, label:"lazy size update",
    ...
    edgeStartOffset!: GraphPoint;
    __info_of__edgeStartOffset: Info = {isEdge: true, type: GraphPoint, label:"start offset",
        txt: "Location where outgoing edges should start their path, relative to top-upper corner of the element."}

    edgeEndOffset!: GraphPoint;
    __info_of__edgeEndOffset: Info = {isEdge: true,  type: GraphPoint, label:"end offset",
    ...
    edgeHeadSize!: GraphPoint;
    __info_of__edgeHeadSize: Info = {isEdge: true, type:GraphPoint, label:"head decorator size", txt:<div>Size of the edge head decorator if present.</div>}

    edgeTailSize!: GraphPoint;
    __info_of__edgeTailSize: Info = {isEdge: true, type:GraphPoint, label:"tail decorator size", txt:<div>Size of the tail head decorator if present.</div>}
