...
//                 }
//                 outstr = '<h4>Resulta:</h4><div class="group result-container"><div class="output-row aa" tabindex="984">' + U.objectInspect(output)+"<span>";
//                 let commentsPopup = "";
...
//                         outstr = U.replaceAll(outstr, "£", "$");
//                     }
//                     if (shortcuts) outstr += "</div></div><br><br>" +
//                         "<h4>Shortcuts</h4><div class='group shortcuts-container'><div class=\"output-row\" tabindex=\"984\">" + U.objectInspect(shortcuts)+"</div>";
...
//                 { this.state.expression && !ashtml && <div className="console-output-container" style={{whiteSpace:"pre"}}>{ outstr }</div>}
//                 <label className={"mt-2"}>Context keys:</label>
//                 {
//                     <div className="context-keys" style={{whiteSpace:"pre"}}> {contextkeys} </div>
//                 }
//             </div>)
//     }
//
