                ...
                <div className={"hover-stuff vertical-centering d-flex "}>
                    <div className={"ms-auto d-flex"} onClick={preventClick}>
                        ...
                        <CommandBar style={{transition: '1s 0.3s', marginTop: '2px'}}>
                            ...
                            /* todo per damiano, la cancellazione non funziona - visto con giordano, l'elemento non è correttamente eliminato, rimane quale dipendenza appesa ("cannot read properties of undefined")*/
                        }
