...
//     }
//
//     static parseDModel(json: Json, metamodel: LModel | undefined): DModelElement[] {
//         let generated: DModelElement[] = [];
//         if (!json) { json = {}; }
//         let dObject: DModel = DModel.new(json[ECoreNamed.namee] as string || "imported_metamodel_1", metamodel.id, !!metamodel, true);
...
//             EcoreParser.parseDPackage(dObject, child, generated, metamodel);
//         }
...
//         return generated; }
//
//     static parseDPackage(parent: DModel | DPackage, json: Json, generated: DModelElement[]): DModelElement[] {
//         if (!generated) generated = [];
//         if (!json) { json = {}; }
...
//         let dObject: DPackage = DPackage.new2({
//             name: this.read(json, ECoreNamed.namee, 'defaultPackage'),
//             /// *** specific start *** ///
//             uri: this.read(json, ECorePackage.nsURI, null),
//             prefix: this.read(json, ECorePackage.nsPrefix, null)
//         }, parent.id, parent.className === DModel.name ? DModel : DPackage);
//         generated.push(dObject);
//         // if (!parent.uri) parent.uri = dObject.uri;
//         // if (!parent.prefix) parent.prefix = dObject.prefix; // namespace
//         /*let dObject: DPackage = DPackage.new15((dObject:DPackage)=>{
...
//         if (!generated) generated = [];
//         if (!json) { json = {}; }
//         let dObject: DClass = DClass.new2({
//             instanceClassName: this.read(json, ECoreClass.instanceTypeName, ''),
//             interface: this.read(json, ECoreClass.interface, 'false') === 'true',
//             abstract: this.read(json, ECoreClass.abstract, 'false') === 'true',
//         }, parent.id, this.read(json, ECoreNamed.namee, 'Concept 1'));
//         generated.push(dObject);
//
//         /// *** specific start *** ///
//         for (let key in json) {
...
//         for (let child of functions) { this.parseDOperation(dObject, json, generated); }
...
//         if (!json) { json = {}; }
//         const childs = this.getChildrens(json);
//         search if paret ad push usages
...
//                 case ECoreEnum.serializable: data.serializable = value === 'true'; break;
//                 case ECoreEnum.instanceTypeName: data.instanceClassName = value + ''; break;
//             }
//         }
//         let dObject: DEnumerator = DEnumerator.new2(data, parent.id, this.read(json, ECoreNamed.namee, 'Enum 1'));
//         generated.push(dObject);
//         for (let child of childs) {
...
//         if (!json) { json = {}; }
//         // const childs = this.getChildrens(json);
//         let literal = this.read(json, EcoreLiteral.literal, '');
//         let dObject: DEnumLiteral = DEnumLiteral.new2({
//             ordinal: +this.read(json, EcoreLiteral.value, Number.NEGATIVE_INFINITY),
//             literal
//         }, parent.id, this.read(json, ECoreNamed.namee,  literal || 'literal_1'));
//         generated.push(dObject);
//         if (parent)
//             return generated; }
//
...
//         if (!json) { json = {}; }
//         const childs = this.getChildrens(json);
//         let dObject: DAttribute = DAttribute.new2({
//             lowerBound: +this.read(json, ECoreAttribute.lowerbound, 0),
//             upperBound: +this.read(json, ECoreAttribute.upperbound, 1),
//         }, parent.id, undefined, this.read(json, ECoreNamed.namee, 'attr_1'));
//         generated.push(dObject);
//
//         /// *** specific start *** ///
...
//         if (!json) { json = {}; }
//         const childs = this.getChildrens(json);
//         let dObject: DReference = DReference.new2({
//             containment: U.fromBoolString(this.read(json, ECoreReference.containment, false), false),
//             lowerBound: +this.read(json, ECoreAttribute.lowerbound, 0),
//             upperBound: +this.read(json, ECoreAttribute.upperbound, 1)
//         }, parent.id, undefined, this.read(json, ECorePackage.namee, 'Ref_1'));
//         generated.push(dObject);
//         /// *** specific start *** ///
...
//         if (!json) { json = {}; }
//         const childs = this.getChildrens(json);
//         let dObject: DParameter = DParameter.new2({
//             lowerBound: +this.read(json, ECoreAttribute.lowerbound, 0),
//             upperBound: +this.read(json, ECoreAttribute.upperbound, 1),
//             ordered: U.fromBoolString(this.read(json, ECoreOperation.ordered, 'false'), false),
//             unique: U.fromBoolString(this.read(json, ECoreOperation.unique, 'false'), false)
//         }, parent.id, undefined, this.read(json, ECoreNamed.namee, 'arg1'));
//         generated.push(dObject);
//         /// *** specific start *** ///
//         dObject.type = this.read(json, ECoreAttribute.eType, AttribETypes.EString);
//         /// *** specific end *** ///
...
//         if (!json) { json = {}; }
//         const childs = this.getChildrens(json);
//         let dObject: DOperation = DOperation.new2({
//             lowerBound: +this.read(json, ECoreAttribute.lowerbound, 1),
//             upperBound: +this.read(json, ECoreAttribute.upperbound, 1),
//             ordered: U.fromBoolString(this.read(json, ECoreOperation.ordered, 'false')),
//             unique: U.fromBoolString(this.read(json, ECoreOperation.unique, 'false')),
//         }, parent.id, undefined, this.read(json, ECoreNamed.namee, 'operation_1'));
//         generated.push(dObject);
//         /// *** specific start *** ///
//         dObject.type = this.read(json, ECoreAttribute.eType, AttribETypes.EString);
//         dObject.exceptions = [this.read(json, ECoreOperation.eexceptions, '')];
//         dObject.visibility = AccessModifier.package;
//         for (let child of childs) { this.parseDParameter(dObject, json, generated); }
//         /// *** specific end *** ///
//         return generated; }
//
//
