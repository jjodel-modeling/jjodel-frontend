...
//
// @RuntimeAccessible
// export class DVoidVertex extends MixOnlyFuncs(DGraphElement, GraphSize) {
//     /// edge without logic
...
// }
// DVoidVertex.subclasses.push(DVertex);
//
// @RuntimeAccessible
...
//             (LPointerTargetable.from(subelement as DGraphElement) as LGraphElement).containedIn = context.data.id as any; // trigger side-action
//         }
//         // old subelements
...
//             if (subelement.containedIn !== context.data.id) continue;
//             (LPointerTargetable.from(subelement as DGraphElement) as LGraphElement).containedIn = undefined; // todo: can this happen? è transitorio o causa vertici senza parent permanenti?
//         }
//         return true;
//     }
// }
...
//     size: GraphSize = undefined as any; // fittizio, size è memorizzata nell'oggetto stesso (estende ISize)
//
//     get_size(context: LogicContext<LVoidVertex>): GraphSize {
