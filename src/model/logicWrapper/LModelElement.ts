...
export class LModelElement<Context extends LogicContext<DModelElement> = any, D extends DModelElement = DModelElement> extends LPointerTargetable {
    ...
    */
    ...
    remove_annotation(val: Pack<LAnnotation>,  context: Context): boolean { // todo: when this will be ever used? this should be triggered by LObject but only get_ / set_ and delete of whole elements should be triggerable.
        const ptrs = Pointers.from(val);
...
export class LReference<Context extends LogicContext<DReference> = any, C extends Context = Context>  extends LStructuralFeature {
    ...
    containment!: boolean;
    container!: boolean;
    resolveProxies!: boolean; // what's this?
    opposite?: LReference;
    target!: LClass[];
    edges!: LEdge[];
