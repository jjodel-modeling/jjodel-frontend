...
Moved to `frontend/src/components/editor-v2/CLAUDE.md` (§3.3) on 2026-09-18
...
Moved to `frontend/src/components/editor-v2/CLAUDE.md` (§3.4) on 2026-09-18
...
Moved to `frontend/src/components/editor-v2/CLAUDE.md` (§3.5) on 2026-09-18
(P-2026-09-18-1930 Phase 1).

### 3.6 entity.father vs forward-link collections

Moved to `frontend/src/model/CLAUDE.md` (§3.6) on 2026-09-18 (P-2026-09-18-1930 Phase 1).

### 3.7 pkg.__raw.uri vs pkg.uri

Moved to `frontend/src/model/CLAUDE.md` (§3.7) on 2026-09-18 (P-2026-09-18-1930 Phase 1).

### 3.8 composition vs containment

Moved to `frontend/src/model/CLAUDE.md` (§3.8) on 2026-09-18 (P-2026-09-18-1930 Phase 1).

### 3.9 VersionFixer & jsxString persistence

Moved to `frontend/src/redux/CLAUDE.md` (§3.9) on 2026-09-18 (P-2026-09-18-1930 Phase 1) — loads
...
Moved to `frontend/src/components/editor-v2/CLAUDE.md` (§3.10) on 2026-09-18
(P-2026-09-18-1930 Phase 1).

### 3.11 Runtime store access

Moved to `frontend/src/components/editor-v2/CLAUDE.md` (§3.11) on 2026-09-18
(P-2026-09-18-1930 Phase 1).

### 3.12 Identity slot ↔ instance name

Moved to `frontend/src/model/CLAUDE.md` (§3.12) on 2026-09-18 (P-2026-09-18-1930 Phase 1).

### 3.13 L-layer proxies report the D-layer className

Moved to `frontend/src/model/CLAUDE.md` (§3.13) on 2026-09-18 (P-2026-09-18-1930 Phase 1).
...
Moved verbatim to `frontend/src/model/CLAUDE.md` (§9, subsections 9.1-9.3) on 2026-09-18
...
Claude Code maintains `docs/claude-code-log.md` as an add-only operational log: entries are never amended, and a new entry goes at the TOP of the file, newest-first per day (R-RAIL-45).
