...
export function estimateBrowserZoom(_window) {
...
export function estimateWindowBorder(_window, addBorder = false) {
...
export function mapElementToScreenRect(element, rect) {
    if (!element) {
        return null;
    }
...
export function mapWindowToElement(targetElement, fromWindow, fromRect, removeBorder = true) {
    if (!targetElement) {
        return null;
    }
    if (fromWindow) {
