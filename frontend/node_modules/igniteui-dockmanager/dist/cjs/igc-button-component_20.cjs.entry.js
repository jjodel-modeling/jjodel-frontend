...
const IgcButtonComponent = class {
  ...
  render() {
    return (index.h(index.Host, { disabled: this.disabled }, index.h("button", { name: this.name, type: this.type, value: this.value, "aria-disabled": this.disabled ? 'true' : null }, index.h("slot", null))));
  }
};
...
const IgcContextMenuComponent = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.menuClosed = index.createEvent(this, "menuClosed", 7);
  ...
  renderItemIcon(item) {
    return (index.h(index.Fragment, null, item.iconName === 'close' && this.renderCloseButton(), item.iconName === 'unpin' && this.renderUnpinButton(), item.iconName !== null && item.iconName !== 'close' && item.iconName !== 'unpin' &&
      index.h("igc-icon-component", { name: item.iconName })));
  }
  renderCloseButton() {
    return (index.h("slot", { name: "contextMenuCloseButton" }, index.h("igc-icon-component", { part: "context-menu-close-button", name: "close" })));
  }
  renderUnpinButton() {
    return (index.h("slot", { name: "contextMenuUnpinButton" }, index.h("igc-icon-component", { part: "context-menu-unpin-button", name: "unpin" })));
  }
  render() {
    return (index.h(index.Host, { part: "context-menu", exportparts: "context-menu,\r\n        menu-item: context-menu-item,\r\n        menu-content: context-menu-content,\r\n        context-menu-close-button,\r\n        context-menu-unpin-button" }, index.h("div", { role: "menu", part: "menu-content", ref: el => this.menuItemsDiv = el, onMouseDown: ev => {
        ev.preventDefault();
      } }, this.items.map(item => {
      const parts = Utils.partNameMap({
        'menu-item': true,
...
class IgcDockManagerService {
  ...
  populatePaneParents(splitPane, isRoot, isInDocHost) {
    ...
    for (const pane of splitPane.panes) {
      ...
      if (pane.type === locale.IgcDockManagerPaneType.contentPane && !pane.hidden) {
      ...
      else if (pane.type === locale.IgcDockManagerPaneType.splitPane) {
        this.populatePaneParents(pane, isRoot, isInDocHost);
      }
      else if (pane.type === locale.IgcDockManagerPaneType.tabGroupPane) {
  ...
  populatePinLocations(splitPane) {
    ...
    for (const pane of splitPane.panes) {
      ...
      else if (pane.type === locale.IgcDockManagerPaneType.contentPane) {
  ...
  resolvePaneUnpinLocation(pane) {
    ...
    if (pane.unpinnedLocation) {
      ...
      unpinnedLocation = documentHost ? this.findPaneUnpinLocation(pane, documentHost) : locale.IgcUnpinnedLocation.left;
    }
  ...
  findPaneUnpinLocation(pane, docHost) {
    ...
    if (commonParentIndex >= 0) {
      ...
      return commonParent.orientation === locale.IgcSplitPaneOrientation.horizontal ?
        paneIndex < docHostIndex ? locale.IgcUnpinnedLocation.left : locale.IgcUnpinnedLocation.right :
        paneIndex < docHostIndex ? locale.IgcUnpinnedLocation.top : locale.IgcUnpinnedLocation.bottom;
    }
    return locale.IgcUnpinnedLocation.left;
  }
  removePane(pane) {
    ...
    if (parent.type === locale.IgcDockManagerPaneType.splitPane ||
      parent.type === locale.IgcDockManagerPaneType.tabGroupPane) {
  ...
  getChildContentPanesRecursive(pane, children) {
    for (const child of pane.panes) {
      ...
      else if (child.type === locale.IgcDockManagerPaneType.tabGroupPane ||
        child.type === locale.IgcDockManagerPaneType.splitPane) {
        this.getChildContentPanesRecursive(child, children);
      }
      else if (child.type === locale.IgcDockManagerPaneType.documentHost) {
  ...
  getChildDocHostRecursive(pane) {
    for (const child of pane.panes) {
      if (child.type === locale.IgcDockManagerPaneType.documentHost) {
        return child;
      }
      else if (child.type === locale.IgcDockManagerPaneType.splitPane) {
  ...
  getPaneToDock(draggedPane) {
    return draggedPane.type === locale.IgcDockManagerPaneType.contentPane ? draggedPane :
      draggedPane.type === locale.IgcDockManagerPaneType.tabGroupPane || draggedPane.type === locale.IgcDockManagerPaneType.splitPane ?
  ...
  dockToCenter(targetPane, draggedPane) {
    ...
    if (targetContainer.type === locale.IgcDockManagerPaneType.tabGroupPane) {
      ...
      if ((draggedPane === null || draggedPane === void 0 ? void 0 : draggedPane.type) === locale.IgcDockManagerPaneType.splitPane && this.dockManager.documentOnlyDrag) {
  ...
  dockToEdge(targetPane, position) {
    ...
    else if ((draggedPane === null || draggedPane === void 0 ? void 0 : draggedPane.type) === locale.IgcDockManagerPaneType.contentPane &&
      this.dockManager.documentOnlyDrag &&
      this.dockManager.dropTargetPaneInfo.floatingPaneWithoutDocHost) {
      draggedPane = {
  ...
  togglePin(pane, pinBehavior = IgcPinBehavior.allPanes) {
    ...
    if (!event.defaultPrevented) {
      ...
      if (this.dockManager.maximizedPane) {
        const targetPanes = parent && parent.type === locale.IgcDockManagerPaneType.tabGroupPane && this.dockManager.maximizedPane === parent
          ? [parent]
          : args.panes;
        this.dockManager.maximizedPane = null;
  ...
  closePane(pane) {
    ...
    if (pane.type === locale.IgcDockManagerPaneType.contentPane && pane !== this.dockManager.flyoutPane) {
      const parent = this.paneParentMap.get(pane);
      if (parent.type === locale.IgcDockManagerPaneType.tabGroupPane) {
        paneToRemove = parent;
      }
    }
  ...
  removeAllowedPanes(sourcePane, pane) {
    ...
    const panes = this.getChildContentPanes(pane)
      ...
      .filter(p => pane.type === locale.IgcDockManagerPaneType.tabGroupPane && sourcePane.type === locale.IgcDockManagerPaneType.contentPane
      ? p.isPinned !== false
      : true);
  ...
  resizeFloatingPane(pane, args) {
    ...
    switch (args.resizerLocation) {
      case (locale.IgcResizerLocation.top):
      case (locale.IgcResizerLocation.topLeft):
      case (locale.IgcResizerLocation.topRight):
        ...
        break;
      case (locale.IgcResizerLocation.bottom):
      case (locale.IgcResizerLocation.bottomLeft):
      case (locale.IgcResizerLocation.bottomRight):
        newHeight = initialHeight + totalOffsetY;
        if (newHeight < minH) {
          newHeight = minH;
        }
    ...
    switch (args.resizerLocation) {
      case (locale.IgcResizerLocation.left):
      case (locale.IgcResizerLocation.topLeft):
      case (locale.IgcResizerLocation.bottomLeft):
        ...
        break;
      case (locale.IgcResizerLocation.right):
      case (locale.IgcResizerLocation.topRight):
      case (locale.IgcResizerLocation.bottomRight):
        newWidth = initialWidth + totalOffsetX;
        if (newWidth < minW) {
  ...
  hasFloatingPaneHeader(pane) {
    ...
    if (panes && panes.length) {
      ...
      if (childPane.type === locale.IgcDockManagerPaneType.splitPane) {
        return this.hasFloatingPaneHeader(childPane);
      }
      else if (childPane.type === locale.IgcDockManagerPaneType.documentHost) {
        return true;
      }
    }
    return false;
  ...
  dockPane(position) {
    ...
    switch (position) {
      ...
      case locale.IgcDockingIndicatorPosition.top:
      ...
      case locale.IgcDockingIndicatorPosition.outerBottom:
  ...
  getSplitPaneVisibleChildren(pane) {
    return pane.panes.filter(p => {
      if (p.type === locale.IgcDockManagerPaneType.contentPane) {
  ...
  dragPaneStart(pane, rect, clientX, clientY) {
    ...
    if (pane.type === locale.IgcDockManagerPaneType.contentPane) {
      ...
      panes = parent.type === locale.IgcDockManagerPaneType.tabGroupPane && pane !== this.dockManager.flyoutPane ?
        parent.panes :
        [pane];
    }
    else {
    ...
    if (pane.type === locale.IgcDockManagerPaneType.contentPane && disableDockingAndFloating) {
      return false;
    }
    ...
    if (pane.type === locale.IgcDockManagerPaneType.splitPane) {
      ...
      const action = {
        type: locale.IgcPaneDragActionType.floatPane,
  ...
  dragPaneEnd() {
    ...
    if (dockingIndicator && this.dockManager.isValidDrop) {
      if (draggedPane.type === locale.IgcDockManagerPaneType.contentPane) {
  ...
  emitDragOverEvent(dockingIndicator) {
    ...
    return this.dockManager.paneDragOver.emit({
      ...
      panes: this.draggedPanes,
      action: {
        type: locale.IgcPaneDragActionType.dockPane,
  ...
  dragOver() {
    ...
    if (this.dockingIndicator) {
      ...
      this.dockManager.dropShadowRect = null;
      if (this.dockManager.draggedPane.type !== locale.IgcDockManagerPaneType.splitPane) {
  ...
  dragTabMove(pane, args, rects) {
    ...
    if (prevHeaderRect
      ...
      const action = {
        type: locale.IgcPaneDragActionType.moveTab,
        oldIndex: paneIndex,
  ...
  normalizeMaximizedPane(pane) {
    if (this.dockManager.maximizedPane) {
      const panes = this.dockManager.maximizedPane.type === locale.IgcDockManagerPaneType.splitPane || this.dockManager.maximizedPane.type === locale.IgcDockManagerPaneType.tabGroupPane
  ...
  resolveAllowMaximize(pane) {
    var _a, _b;
    if (pane.type === locale.IgcDockManagerPaneType.splitPane || pane.type === locale.IgcDockManagerPaneType.tabGroupPane) {
      ...
      const parent = this.getParent(pane);
      return parent.type === locale.IgcDockManagerPaneType.tabGroupPane
...
class IgcDockManagerKeyboardService {
  ...
  handleDockPane(event) {
    ...
    if (ctrlOrMetaKey && shiftKey) {
      ...
      if (activePaneParent.type === locale.IgcDockManagerPaneType.tabGroupPane && activePaneParent.panes.length > 1) {
...
const IgcDockManager = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.paneHeaderConnected = index.createEvent(this, "paneHeaderConnected", 7);
    this.paneHeaderDisconnected = index.createEvent(this, "paneHeaderDisconnected", 7);
    this.tabHeaderConnected = index.createEvent(this, "tabHeaderConnected", 7);
    this.tabHeaderDisconnected = index.createEvent(this, "tabHeaderDisconnected", 7);
    ...
    this.paneDragOver = index.createEvent(this, "paneDragOver", 7);
    this.paneDragEnd = index.createEvent(this, "paneDragEnd", 7);
    this.floatingPaneResizeMove = index.createEvent(this, "floatingPaneResizeMove", 7);
    this.floatingPaneResizeEnd = index.createEvent(this, "floatingPaneResizeEnd", 7);
    this.floatingPaneResizeStart = index.createEvent(this, "floatingPaneResizeStart", 7);
    this.layoutChange = index.createEvent(this, "layoutChange", 7);
  ...
  activePaneChange(newValue, oldValue) {
    ...
    if (newValue) {
      if (newValue.isPinned === false) {
        ...
        if (parent.type === locale.IgcDockManagerPaneType.tabGroupPane && parent.panes.length > 1) {
  ...
  isPaneSizeWithinConstraints(pane, offset, orientation, position = 'next') {
    ...
    if (orientation === locale.IgcSplitPaneOrientation.horizontal) {
  ...
  handleFlyoutSplitterResizeEnd(pane, orientation, event) {
    ...
    const minSize = orientation === locale.IgcSplitPaneOrientation.horizontal
  ...
  getInnerDropTargetParentRect() {
    if (this.dropTargetPaneInfo && this.service.proximityDockPosition) {
      ...
      const targetPaneParent = this.allowOuterProximityDock && Utils.isDockingIndicatorOuter(this.service.proximityDockPosition)
        ? isSameSplitPane
          ? targetDocHostParent
  ...
  getProximityDockPosition() {
    ...
    if (this.allowOuterProximityDock && this.splitterRect) {
      if (this.cursorLocation.x >= this.splitterRect.left - this.proximityOuterDockThreshold
        && this.cursorLocation.x <= this.splitterRect.left) {
        return locale.IgcDockingIndicatorPosition.outerLeft;
      }
      else if (this.cursorLocation.x <= this.splitterRect.right + this.proximityOuterDockThreshold
        && this.cursorLocation.x >= this.splitterRect.right) {
        return locale.IgcDockingIndicatorPosition.outerRight;
      }
    }
    ...
    if (this.cursorLocation.y > targetPaneRect.bottom - this.proximityDockThreshold
      ...
      && !isOverSplitter) {
      return allowOuterBottomDock ? locale.IgcDockingIndicatorPosition.outerBottom : locale.IgcDockingIndicatorPosition.bottom;
    }
      ...
      && !isOverSplitter) {
      return allowOuterTopDock ? locale.IgcDockingIndicatorPosition.outerTop : locale.IgcDockingIndicatorPosition.top;
    }
  ...
  handleTabHeaderDragStart(pane, event) {
    ...
    if (rootParent !== this.layout.rootPane &&
      path.some(p => p.type === locale.IgcDockManagerPaneType.documentHost)) {
  ...
  renderButtonsTemplates() {
    return (index.h("template", null, index.h("slot", { name: "paneHeaderCloseButton", onSlotchange: this.updateTemplates }), index.h("slot", { name: "tabHeaderCloseButton", onSlotchange: this.updateTemplates }), index.h("slot", { name: "closeButton", onSlotchange: this.updateTemplates }), index.h("slot", { name: "moreTabsButton", onSlotchange: this.updateTemplates }), index.h("slot", { name: "maximizeButton", onSlotchange: this.updateTemplates }), index.h("slot", { name: "minimizeButton", onSlotchange: this.updateTemplates }), index.h("slot", { name: "pinButton", onSlotchange: this.updateTemplates }), index.h("slot", { name: "unpinButton", onSlotchange: this.updateTemplates }), index.h("slot", { name: "moreOptionsButton", onSlotchange: this.updateTemplates }), index.h("slot", { name: "splitterHandle", onSlotchange: this.updateTemplates })));
  }
  renderContentPane(pane, isFloating, isFlyout) {
    ...
    return (index.h("igc-content-pane-component", { key: pane.id, contentId: pane.contentId, size: pane.size, isFlyout: isFlyout, unpinnedSize: pane.unpinnedSize, disabled: pane.disabled, isSingleFloating: isSingleFloatingContentPane, onMouseMove: this.togglePaneHeaderVisibility.bind(this, pane), onMouseLeave: this.removeHoveredPane.bind(this), ref: el => {
      ...
      } }, (isFloating && pane.floatingHeaderId) ? index.h("slot", { name: pane.floatingHeaderId }) :
  ...
  renderTabGroup(pane, isFloating, isInDocumentHost) {
    ...
    const selectedIndex = pane.type === locale.IgcDockManagerPaneType.tabGroupPane && pane.selectedIndex ?
    ...
    let contentIds = [];
    if (pane.type === locale.IgcDockManagerPaneType.tabGroupPane) {
  ...
  renderSplitPane(splitPane, isFloating, isInDocumentHost) {
    ...
    return (splitPane.allowEmpty || panes.length > 0) && (index.h("igc-split-pane-component", { key: splitPane.id, orientation: splitPane.orientation, size: splitPane.size, onRendered: this.handleSplitPaneRendered.bind(this, panes), ref: el => {
      ...
      let paneComponent;
      if (p.type === locale.IgcDockManagerPaneType.splitPane) {
  ...
  renderUnpinnedTabArea(location) {
    ...
    const isLeft = location === locale.IgcUnpinnedLocation.left;
    const isRight = location === locale.IgcUnpinnedLocation.right;
    const isBottom = location === locale.IgcUnpinnedLocation.bottom;
  ...
  renderFlyoutPane() {
    ...
    const flyoutClasses = {
      'flyout-pane': true,
      'flyout-pane--right': location === locale.IgcUnpinnedLocation.right,
      'flyout-pane--bottom': location === locale.IgcUnpinnedLocation.bottom,
      'flyout-pane--left': location === locale.IgcUnpinnedLocation.left,
    };
    let splitPaneOrientation = locale.IgcSplitPaneOrientation.vertical;
    if (location === locale.IgcUnpinnedLocation.left || location === locale.IgcUnpinnedLocation.right) {
  ...
  renderFloatingPanes() {
    var _a, _b;
    return (index.h("div", { class: "floating-panes", style: { position: this.maximizedPane ? 'absolute' : 'fixed' } }, (_b = (_a = this.layout) === null || _a === void 0 ? void 0 : _a.floatingPanes) === null || _b === void 0 ? void 0 : _b.map(p => {
      var _a;
  ...
  renderDropShadow() {
    var _a, _b, _c, _d;
    return this.dropShadowRect && (index.h("div", { part: "docking-preview", class: "drop-shadow", style: {
...
const IgcFloatingPaneComponent = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.wndResizeStart = index.createEvent(this, "wndResizeStart", 7);
    this.wndResizeMove = index.createEvent(this, "wndResizeMove", 7);
    this.wndResizeEnd = index.createEvent(this, "wndResizeEnd", 7);
  ...
  render() {
    ...
    return (index.h(index.Host, { style: this.maximized ? {} : styles, role: "dialog", "aria-label": "dialog", part: "floating-window" }, this.allowResize &&
      index.h(index.Fragment, null, index.h("igc-resizer-component", { orientation: locale.IgcResizerLocation.left, onResizerDragStart: this.handleResizeStart.bind(this), onResizerMoved: this.handleResizerMove.bind(this), onResizerDragEnd: this.handleResizeEnd.bind(this) }), index.h("igc-resizer-component", { orientation: locale.IgcResizerLocation.top, onResizerDragStart: this.handleResizeStart.bind(this), onResizerMoved: this.handleResizerMove.bind(this), onResizerDragEnd: this.handleResizeEnd.bind(this) }), index.h("igc-resizer-component", { orientation: locale.IgcResizerLocation.right, onResizerDragStart: this.handleResizeStart.bind(this), onResizerMoved: this.handleResizerMove.bind(this), onResizerDragEnd: this.handleResizeEnd.bind(this) }), index.h("igc-resizer-component", { orientation: locale.IgcResizerLocation.bottom, onResizerDragStart: this.handleResizeStart.bind(this), onResizerMoved: this.handleResizerMove.bind(this), onResizerDragEnd: this.handleResizeEnd.bind(this) })), index.h("slot", { name: "header" }), index.h("slot", null), this.allowResize &&
      index.h(index.Fragment, null, index.h("igc-resizer-component", { orientation: locale.IgcResizerLocation.topRight, onResizerDragStart: this.handleResizeStart.bind(this), onResizerMoved: this.handleResizerMove.bind(this), onResizerDragEnd: this.handleResizeEnd.bind(this) }), index.h("igc-resizer-component", { orientation: locale.IgcResizerLocation.topLeft, onResizerDragStart: this.handleResizeStart.bind(this), onResizerMoved: this.handleResizerMove.bind(this), onResizerDragEnd: this.handleResizeEnd.bind(this) }), index.h("igc-resizer-component", { orientation: locale.IgcResizerLocation.bottomRight, onResizerDragStart: this.handleResizeStart.bind(this), onResizerMoved: this.handleResizerMove.bind(this), onResizerDragEnd: this.handleResizeEnd.bind(this) }), index.h("igc-resizer-component", { orientation: locale.IgcResizerLocation.bottomLeft, onResizerDragStart: this.handleResizeStart.bind(this), onResizerMoved: this.handleResizerMove.bind(this), onResizerDragEnd: this.handleResizeEnd.bind(this) }))));
  }
  get elem() { return index.getElement(this); }
};
...
const IgcIconComponent = class {
  ...
  render() {
    return (index.h(index.Host, { innerHTML: icons[this.name] }));
  }
};
...
const IgcJoystickIconComponent = class {
  ...
  renderIcon() {
    ...
    if (position === locale.IgcDockingIndicatorPosition.outerLeft ||
      (position === locale.IgcDockingIndicatorPosition.left && !this.isDocHost)) {
      return index.h("igc-icon-component", { name: "chevron_left" });
    }
    else if (position === locale.IgcDockingIndicatorPosition.left) {
      return (index.h("igc-icon-component", { name: "flip", style: { transform: 'rotate(180deg)' } }));
    }
    else if (position === locale.IgcDockingIndicatorPosition.outerTop ||
      (position === locale.IgcDockingIndicatorPosition.top && !this.isDocHost)) {
      return (index.h("igc-icon-component", { name: "chevron_left", style: { transform: 'rotate(90deg)' } }));
    }
    else if (position === locale.IgcDockingIndicatorPosition.top) {
      return (index.h("igc-icon-component", { name: "flip", style: { transform: 'rotate(270deg)' } }));
    }
    else if (position === locale.IgcDockingIndicatorPosition.center) {
      return index.h("igc-icon-component", { name: "crop_square" });
    }
    else if (position === locale.IgcDockingIndicatorPosition.outerRight ||
      (position === locale.IgcDockingIndicatorPosition.right && !this.isDocHost)) {
      return (index.h("igc-icon-component", { name: "chevron_left", style: { transform: 'rotate(180deg)' } }));
    }
    else if (position === locale.IgcDockingIndicatorPosition.right) {
      return index.h("igc-icon-component", { name: "flip" });
    }
    else if (position === locale.IgcDockingIndicatorPosition.outerBottom ||
      (position === locale.IgcDockingIndicatorPosition.bottom && !this.isDocHost)) {
      return (index.h("igc-icon-component", { name: "chevron_left", style: { transform: 'rotate(270deg)' } }));
    }
    else if (position === locale.IgcDockingIndicatorPosition.bottom) {
      return (index.h("igc-icon-component", { name: "flip", style: { transform: 'rotate(90deg)' } }));
    }
  }
  render() {
    return (index.h(index.Host, { part: "docking-indicator", class: this.resolveIconDivClass(), style: {
...
const IgcJoystickIndicatorComponent = class {
  ...
  shouldAllowCenterDock() {
    ...
    return targetPane.type === locale.IgcDockManagerPaneType.contentPane && targetPane.acceptsInnerDock !== undefined && this.allowCenterDock
      ? targetPane.acceptsInnerDock
...
const IgcPaneHeaderComponent = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.pinToggle = index.createEvent(this, "pinToggle", 7);
    this.maximize = index.createEvent(this, "maximize", 3);
    this.close = index.createEvent(this, "close", 7);
    this.dragStarted = index.createEvent(this, "dragStarted", 7);
    this.dragEnded = index.createEvent(this, "dragEnded", 7);
    this.dragMoved = index.createEvent(this, "dragMoved", 7);
    this.elementConnected = index.createEvent(this, "elementConnected", 7);
  ...
  renderCloseButton() {
    return (index.h("slot", { name: "paneHeaderCloseButton" }, index.h("igc-button-component", { part: "pane-header-close-button" }, index.h("igc-icon-component", { name: "close", "aria-label": this.resourceStrings.close, title: this.resourceStrings.close }))));
  }
  renderMaximizeButton() {
    return (index.h("slot", { name: "paneHeaderMaximizeButton" }, index.h("igc-button-component", { part: "pane-header-maximize-button" }, index.h("igc-icon-component", { name: "maximize", "aria-label": this.resourceStrings.maximize, title: this.resourceStrings.maximize }))));
  }
  renderMinimizeButton() {
    return (index.h("div", null, index.h("slot", { name: "paneHeaderMinimizeButton" }, index.h("igc-button-component", { part: "pane-header-minimize-button" }, index.h("igc-icon-component", { name: "minimize", "aria-label": this.resourceStrings.minimize, title: this.resourceStrings.minimize })))));
  }
  renderPinButton() {
    return (index.h(index.Fragment, null, !this.isFloating && index.h("slot", { name: "paneHeaderPinButton" }, index.h("igc-button-component", { part: "pane-header-pin-button", style: { display: this.isFloating ? 'none' : 'flex' } }, index.h("igc-icon-component", { name: "pin", "aria-label": this.resourceStrings.pin, title: this.resourceStrings.pin })), " ")));
  }
  renderUnpinButton() {
    return (index.h(index.Fragment, null, !this.isFloating && index.h("slot", { name: "paneHeaderUnpinButton" }, index.h("igc-button-component", { part: "pane-header-unpin-button", style: { display: this.isFloating ? 'none' : 'flex' } }, index.h("igc-icon-component", { name: "unpin", "aria-label": this.resourceStrings.unpin, title: this.resourceStrings.unpin })))));
  }
  render() {
    const commonParts = {
    ...
    return (index.h(index.Host, { part: paneHeaderParts, exportparts: exportParts }, index.h("div", { part: paneHeaderContentParts, class: "header-text" }, index.h("slot", null)), index.h("div", { part: paneHeaderActionsParts, class: "header-actions", [IGNORE_DRAG]: true }, this.allowPinning &&
      index.h("div", { onClick: this.pinButtonClick }, this.pinned ? this.renderUnpinButton() : this.renderPinButton()), this.allowMaximize &&
      index.h("div", { onClick: this.maximizeButtonClick }, this.maximized ? this.renderMinimizeButton() : this.renderMaximizeButton()), this.allowClose &&
      index.h("div", { onClick: this.closeButtonClick }, this.renderCloseButton()))));
  }
  get element() { return index.getElement(this); }
  static get watchers() { return {
...
const IgcResizerComponent = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.resizerMoved = index.createEvent(this, "resizerMoved", 7);
    this.resizerDragStart = index.createEvent(this, "resizerDragStart", 7);
    this.resizerDragEnd = index.createEvent(this, "resizerDragEnd", 7);
    this.dragStart = (args) => {
  ...
  get isCornerResizer() {
    return this.orientation === locale.IgcResizerLocation.bottomLeft || this.orientation === locale.IgcResizerLocation.bottomRight ||
      this.orientation === locale.IgcResizerLocation.topLeft || this.orientation === locale.IgcResizerLocation.topRight;
  }
  connectedCallback() {
    this.dragService = new IgcDragService(this.element);
  ...
  render() {
    return (index.h(index.Host, { style: {
        position: 'absolute',
        pointerEvents: 'all',
        height: (this.orientation === locale.IgcResizerLocation.left || this.orientation === locale.IgcResizerLocation.right) ?
          '100%' : this.isCornerResizer ? '10px' : '5px',
        width: (this.orientation === locale.IgcResizerLocation.left || this.orientation === locale.IgcResizerLocation.right) ? '5px' :
          this.isCornerResizer ? '10px' : '100%',
        cursor: this.orientation === locale.IgcResizerLocation.left || this.orientation === locale.IgcResizerLocation.right ?
          'ew-resize' : (this.orientation === locale.IgcResizerLocation.bottomLeft || this.orientation === locale.IgcResizerLocation.topRight) ?
          'ne-resize' : (this.orientation === locale.IgcResizerLocation.bottomRight || this.orientation === locale.IgcResizerLocation.topLeft) ?
          'nw-resize' : 'ns-resize',
        left: this.orientation === locale.IgcResizerLocation.left || this.orientation === locale.IgcResizerLocation.topLeft ||
          this.orientation === locale.IgcResizerLocation.bottomLeft ? '-3px' : null,
        top: this.orientation === locale.IgcResizerLocation.top || this.orientation === locale.IgcResizerLocation.topLeft ||
          this.orientation === locale.IgcResizerLocation.topRight ? '0px' : null,
        right: this.orientation === locale.IgcResizerLocation.right || this.orientation === locale.IgcResizerLocation.bottomRight ||
          this.orientation === locale.IgcResizerLocation.topRight ? '-3px' : null,
        bottom: this.orientation === locale.IgcResizerLocation.bottom || this.orientation === locale.IgcResizerLocation.bottomRight ||
          this.orientation === locale.IgcResizerLocation.bottomLeft ? '-3px' : null,
        zIndex: '10002'
      } }));
  }
...
const IgcRootDockingIndicatorComponent = class {
  ...
  render() {
    return (index.h(index.Host, { part: "root-docking-indicator" }, index.h("igc-icon-component", { name: "first_page", style: {
        transform: this.position === locale.IgcDockingIndicatorPosition.top ? 'rotate(90deg)' :
          this.position === locale.IgcDockingIndicatorPosition.right ? 'rotate(180deg)' :
            this.position === locale.IgcDockingIndicatorPosition.bottom ? 'rotate(270deg)' : 'rotate(0deg)'
      } })));
  }
};
...
const IgcSplitterComponent = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.resizeStart = index.createEvent(this, "resizeStart", 7);
    this.resizeEnd = index.createEvent(this, "resizeEnd", 7);
    this.handleMouseUp = () => {
  ...
  handleKeydownEvent(event) {
    if (this.splitPaneOrientation === locale.IgcSplitPaneOrientation.horizontal &&
      (!this.isArrowLeft(event) && !this.isArrowRight(event))) {
      return;
    }
    if (this.splitPaneOrientation === locale.IgcSplitPaneOrientation.vertical &&
  ...
  dragStartHelper(dragOffset) {
    ...
    if (this.flyoutLocation) {
      ...
      this.paneSizes = [this.splitPaneOrientation === locale.IgcSplitPaneOrientation.horizontal ?
          pane.offsetWidth : pane.offsetHeight];
      this.flyoutMaxSize = this.splitPaneOrientation === locale.IgcSplitPaneOrientation.horizontal ?
      ...
      this.paneSizes = panes.map(p => this.splitPaneOrientation === locale.IgcSplitPaneOrientation.horizontal ?
  ...
  constrainFlyoutResize() {
    ...
    const isStartLocation = this.flyoutLocation === locale.IgcUnpinnedLocation.left || this.flyoutLocation === locale.IgcUnpinnedLocation.top;
  ...
  render() {
    ...
    return (index.h(index.Host, { part: "splitter", exportparts: "splitter,\r\n        splitter-base,\r\n        splitter-ghost" }, index.h("div", { part: "splitter-base", class: splitterClasses, tabIndex: 0, role: "separator", "aria-orientation": this.splitPaneOrientation.toString() }, index.h("slot", { name: "splitterHandle", onSlotchange: this.handleSlotChange.bind(this) })), this.showDragGhost &&
...
const IgcTabHeaderComponent = class {
  constructor(hostRef) {
    ...
    this.dragMoved = index.createEvent(this, "dragMoved", 7);
    this.dragEnded = index.createEvent(this, "dragEnded", 7);
    this.tabMouseDown = index.createEvent(this, "tabMouseDown", 7);
    this.iconClicked = index.createEvent(this, "iconClicked", 7);
    this.iconKeyDown = index.createEvent(this, "iconKeyDown", 7);
    this.elementConnected = index.createEvent(this, "elementConnected", 7);
    this.elementDisconnected = index.createEvent(this, "elementDisconnected", 7);
    this.iconClick = (ev) => {
  ...
  render() {
    ...
    return (index.h(index.Host, { role: "tab", part: parts, exportparts: exportparts, "aria-label": this.header, "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false', tabIndex: !this.selected || this.disabled ? -1 : 0 }, index.h("slot", null), this.iconName &&
      index.h("div", { part: tabParts, onClick: this.iconClick, onKeyDown: this.keyDown, [IGNORE_DRAG]: true }, this.iconName === 'close' ? this.renderCloseButton() : this.renderMoreOptionsButton())));
  }
  get element() { return index.getElement(this); }
  static get watchers() { return {
    "forcedDrag": ["forcedDragChanged"],
...
const IgcTabsComponent = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.maximize = index.createEvent(this, "maximize", 7);
    this.maximizeMinimizeFocus = index.createEvent(this, "maximizeMinimizeFocus", 7);
  ...
  renderTabHeaders(top) {
    ...
    return (index.h("div", { part: tabStripParts, style: {
        display: this.hasHeaders ? 'flex' : 'none'
      }, class: classes, onKeyDown: this.onTabKeyDown }, index.h("div", { class: {
  ...
  renderMoreTabsButton() {
    return (index.h("span", null, index.h("slot", { name: "tabsMoreButton" }, index.h("igc-button-component", { part: "tabs-more-button" }, index.h("igc-icon-component", { name: "more", "aria-label": this.resourceStrings.moreTabs, title: this.resourceStrings.moreTabs, style: {
        display: 'block'
      } })))));
  }
  renderMaximizeButton() {
    return (index.h("div", null, index.h("slot", { name: "tabsMaximizeButton" }, index.h("igc-button-component", { part: "tabs-maximize-button" }, index.h("igc-icon-component", { name: "maximize", "aria-label": this.resourceStrings.maximize, title: this.resourceStrings.maximize })))));
  }
  renderMinimizeButton() {
    return (index.h("slot", { name: "tabsMinimizeButton" }, index.h("igc-button-component", { part: "tabs-minimize-button" }, index.h("igc-icon-component", { name: "minimize", "aria-label": this.resourceStrings.minimize, title: this.resourceStrings.minimize }))));
  }
  render() {
    const size = this.size || this.size === 0 ? this.size : IGC_DEFAULT_PANE_SIZE;
...
locale.addResourceStrings('custom', customResourceStrings);
          ...
          },
          {
            ...
            panes: [
              ...
              },
              {
                ...
                header: 'Properties',
                contentId: 'content5',
                unpinnedLocation: locale.IgcUnpinnedLocation.top,
                allowFloating: false,
                allowMaximize: false
              }
            ]
...
exports.igc_button_component = IgcButtonComponent;
exports.igc_content_pane_component = IgcContentPaneComponent;
exports.igc_context_menu_component = IgcContextMenuComponent;
exports.igc_dockmanager = IgcDockManager;
exports.igc_document_host_component = IgcDocumentHostComponent;
exports.igc_floating_pane_component = IgcFloatingPaneComponent;
exports.igc_icon_component = IgcIconComponent;
exports.igc_joystick_icon_component = IgcJoystickIconComponent;
exports.igc_joystick_indicator_component = IgcJoystickIndicatorComponent;
exports.igc_pane_header_component = IgcPaneHeaderComponent;
exports.igc_pane_navigator_component = IgcPaneNavigatorComponent;
exports.igc_resizer_component = IgcResizerComponent;
exports.igc_root_docking_indicator_component = IgcRootDockingIndicatorComponent;
exports.igc_split_pane_component = IgcSplitPaneComponent;
exports.igc_splitter_component = IgcSplitterComponent;
exports.igc_tab_header_component = IgcTabHeaderComponent;
exports.igc_tab_panel_component = IgcTabPanelComponent;
exports.igc_tabs_component = IgcTabsComponent;
exports.igc_unpinned_pane_header_component = IgcUnpinnedPaneHeaderComponent;
exports.sample_component = SampleComponent;

//# sourceMappingURL=igc-button-component_20.cjs.entry.js.map