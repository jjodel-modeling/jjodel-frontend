...
.smart-data-view-header {
  ...
  position: relative;
  display: grid;
  grid-template-areas: "customize filter sort format details delete . search";
  grid-template-columns: minmax(50px, max-content) minmax(50px, max-content) minmax(50px, max-content) minmax(50px, max-content) minmax(50px, max-content) minmax(50px, max-content) 1fr 24px;
  grid-gap: 10px;
