...
Loaded only when working under `frontend/src/model/`. Moved verbatim out of the root `AGENTS.md`
...
the root `AGENTS.md` — an agent must see them *before* deciding to act, and therefore before this
