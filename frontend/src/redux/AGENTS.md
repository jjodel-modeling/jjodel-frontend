...
Loaded only when working under `frontend/src/redux/`. Moved verbatim out of the root `AGENTS.md`
...
§3.2 (the Layer Impact Report template) stay in the root `AGENTS.md` — an agent must see them
