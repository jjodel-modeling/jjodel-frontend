# jjel — Expression Language working rules

Loaded only when working under `frontend/src/jjel/`. Moved verbatim out of the root
`CLAUDE.md` (§11) on 2026-09-19 (P-2026-09-18-1930 Phase 3).
