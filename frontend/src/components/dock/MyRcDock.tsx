...
export class PinnableDock extends DockLayout{
    ...
    static defaultLayout: LayoutData = { // generated by PinnableDock.instance.saveLayout()
        "dockbox": {
            "id": "+23",
            "size": 200,
            "mode": "horizontal",
            "children": [
                ...
                },
                {
                    ...
                    "tabs": [
                        ...
                        {"id": "DockComponent_rightbar_6"},
                        {"id": "DockComponent_rightbar_8"},
                        {"id": "DockComponent_rightbar_5"},
                        {"id": "DockComponent_rightbar_9"},
                        {"id": "DockComponent_rightbar_10"}
                    ],
                    "group": "editors",
                    "activeId": "DockComponent_rightbar_2"
                }
            ]
        },
        "floatbox": {
    ...
    static saveSlotName: string = '1';
    static saveSlotCategory: string = 'user';
    static load(slot: string, category: string = ''): void {
        PinnableDock.saveSlotName = slot;
        PinnableDock.saveSlotCategory = category;
