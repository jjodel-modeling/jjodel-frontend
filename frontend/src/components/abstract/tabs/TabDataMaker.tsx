...
class TabDataMaker {
    static metamodel (model: DModel|LModel): TabData {
        return {
            id: model.id,
            title: <div className={"active-on-mouseenter"}><ElementBadge type="metamodel" /> {model.name}</div>,
            group: 'models',
            closable: true,
    ...
    static model(model: DModel|LModel): TabData {
        return {
            id: model.id,
            title: <div className={"active-on-mouseenter"}><ElementBadge type="model" /> {model.name}</div>,
            group: 'models',
            closable: true,
